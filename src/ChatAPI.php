...
use ChatAPI\Exceptions\CouldNotSendNotification;
...
class ChatAPI
{
    ...
    public function extractFiledata($file, $filename = null, $mimetype = null) : array
    {
        if (empty($file)) {
    ...
    public function sendFile($phone, $file, $filename=null, $mimetype=null)
    {
        ...
        try {
            $data = $this->extractFiledata($file, $filename, $mimetype);
    ...
    public function sendAPIMessage(ChatAPIMessage $chatAPIMessage)
    {
